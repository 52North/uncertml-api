 ...
 */
public class QuantileTypeImpl extends org.uncertml.x20.impl.AbstractSummaryStatisticTypeImpl implements org.uncertml.x20.QuantileType
{
    private static final long serialVersionUID = 1L;
    
    public QuantileTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.uncertml.x20.QuantileType.Level xgetLevel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.uncertml.x20.QuantileType.Level target = null;
            target = (org.uncertml.x20.QuantileType.Level)get_store().find_attribute_user(LEVEL$2);
            return target;
        }
    }
     ...
     */
    public void xsetLevel(org.uncertml.x20.QuantileType.Level level)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.uncertml.x20.QuantileType.Level)get_store().add_attribute_user(LEVEL$2);
            }
            target.set(level);
        }
    }
     ...
     */
    public static class LevelImpl extends org.apache.xmlbeans.impl.values.JavaDoubleHolderEx implements org.uncertml.x20.QuantileType.Level
    {
        private static final long serialVersionUID = 1L;
